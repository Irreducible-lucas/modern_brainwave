   ...
   <Section crosses >
    <div className='container lg:flex'>
      <div className='max-w-[25rem] '>
        <h2 className='h2 mb-4 md:mb-8'>AI Chat App for seamless collaboraton</h2>
      ...
      <div className='lg:ml:auto xl:w-[38rem]'>
        <p className='body-2 mb-12 text-n-4 md:mb-16 lg:mb-32 lg:w-[22rem] lg:mx-auto mt-4'>{collabText}</p>
        <div className='mt-8 relative left-1/2 w-[22rem] flex  aspect-square border border-n-6 rounded-full -translate-x-1/2 scale-75 md:scale-100'>
