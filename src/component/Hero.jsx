    ...
    <div className="container relative" ref={parallaxRef}>
      <div className="relative z-1  max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
        <h1 className="h1 mb-6 mt-20">
          ...
          <span className="inline-block relative">Brainwave <img src={curve} alt="Curve" className="absolute top-full left-0 w-full xl:-mt-2"  width={624} height={28}/>
          </span>
        </h1>
        <p className="body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8">
          Unleash the powwer of AI within Brainwave.upgrade your productivity with brainwave. the open AI chat app.
        </p>
        <Button href="/" white>
          Get started
        </Button>
      ...
      <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
        <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient ">
          <div className="relative bg-n-8 rounde-[1rem]">
