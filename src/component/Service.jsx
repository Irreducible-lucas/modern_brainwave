     ...
     <div className='container'>
      ...
      <div className='relative'>
        ...
        <div className='absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto'>
          <img src={service1} className='w-full h-full object-cover' width={800} height={730} alt='Smartest AI'/>
        </div>
       ...
       <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2" />
        ...
        <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
          ...
          <p className='body-2 mb-[3rem] text-n-3'>Automatically enhance your photos using our AI app's photos using our AI app's photo editing feature. Try it now!</p>
        </div>
        <PhotoChatMessage />
          </div>
